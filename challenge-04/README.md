...
carro.adcionarPessoas = function (pessoas){
    ...
    if(totalPessoas == carro.assentos){
     ...
     if(totalPessoas > carro.assentos){
         cabePessoas = carro.assentos - carro.quantidadePessoas;
         var pluralOuSingular = cabePessoas == 1 ? 'pessoa' : 'pessoas';
         return 'So cabem mais ' + cabePessoas + ' ' + pluralOuSingular; 
     }
...
//'Esse carro e um chevrolet onix'

// Adicione 2 pessoas no carro.
carro.adcionarPessoas(2);
//'Ja temos 2 Pessoas no carro'

// Adicione mais 4 pessoas no carro.
carro.adcionarPessoas(4);
//'So cabem mais 3 pessoas'

// Faça o carro encher.
carro.adcionarPessoas(3);
//'O carro esta lotado'
