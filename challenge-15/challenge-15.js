...
var Jose = new person('Jose', 'Antonio', 21);
var Ana = new person('Ana', 'Paula', 23);
var Paulo = new person('Paulo', 'Carlos', 19);
console.log(Jose);
console.log(Ana);
console.log(Paulo);
/*
...
console.log(Jose.getFullName() + ' agora tem ' + Jose.addAge(4) + ' anos');
console.log(Ana.getFullName() + ' agora tem ' + Ana.addAge(2) + ' anos');
console.log(Paulo.getFullName() + ' agora tem ' + Paulo.addAge(3) + ' anos');
