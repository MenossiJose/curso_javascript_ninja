...
var textName = text.replace(/Manuel Marques de Sousa/g, 'Jose Antonio Menossi');
...
console.log(text.replace(/brasileiro/g, 'sertanopolense'));
...
var replaceCentauro = text.replace(/O Centauro de Luvas/g, function (frase){
	return frase.toUpperCase();

});
console.log(replaceCentauro);
/*
...
console.log(getMonthNumber('marco'))
...
var regexData = /(\d\d) de (junho|julho) de (\d\d\d\d)/;
