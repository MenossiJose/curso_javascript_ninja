...
*/
// ?
var teams = ['Sao Paulo', 'Palmeiras', 'Corinthians', 'Santos', 'Bragantino'];
...
function showTeamPosition (x){
    if(x <= 5){
    console.log('O time que esta em ' + x + ' lugar e o ' + teams[x-1]);
    }
    else{
        console.log('Nao temos a informacao do time que esta nessa posicao');
