...
for( var i = 0; i < name.length; i++){
	console.log(name.charAt(i) + ' e a ' + (i+1) + ' letra do meu nome');
}
...
var fullName = 'jose-antonio'
var novofullName = fullName.split('-').map(function (name){
	return name.charAt(0).toUpperCase() + name.slice(1);
});

console.log(novofullName.join(' '));
/*
...
*/
console.log( '\nMeus amigos:' );
var amigos = ['jose', 'dudu', 'marcos', 'guto']
...
console.log(frase + ' sao meus amigos.');
